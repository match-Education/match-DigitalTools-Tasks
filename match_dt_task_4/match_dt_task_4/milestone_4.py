...
class Milestone4Node(Node):
    def __init__(self) -> None:
        super().__init__('milestone_4')
...
def main(args = None):
    ...
    milestone_4_node: Milestone4Node = Milestone4Node()
